...
public class UpdateController {
    ...
    public void setView(SendMessage sendMessage) {
        System.out.println("UpdateController.setView() called with message: " + sendMessage);
        if (sendMessage.getReplyMarkup() != null) {
            System.out.println("UpdateController.setView() Keyboard: " + sendMessage.getReplyMarkup().toString());
        } else {
            System.out.println("UpdateController.setView(): no keyboard in sendMessage");
        }
        telegramBot.sendAnswerMessage(sendMessage);
    }
