                    ...
                    switch (statusNumber) {
                        ...
                        case "0.0":
                            sb.append("Заказ не найден" +
                                    "\n" +
                                    "\n" +
                                    "Информация об отправленном заказе станет доступна после его проверки оператором. " +
                                    "Обычно, это занимает 1-3 минуты." +
                                    "\n" +
                                    "\n" +
                                    "Если вы оформили заказ на следующие дни, информация о них станет доступна, в день на который была оформлена доставка." +
                                    "\n" +
                                    "Для немедленной проверки заказа оформленного на следующие дни, Вы можете связаться с оператором по телефону:" +
                                    "+73512400400"
                            );
                            break;
                        case "1.0":
